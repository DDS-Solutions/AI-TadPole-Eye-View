...
| [0032](./0032-mcp-sdk-transport-protocol-session-design.md) | Incremental official MCP SDK adoption with preserved stdio compatibility | Accepted; HTTP implementation blocked on OQ-1 | 2026-09-08 |
