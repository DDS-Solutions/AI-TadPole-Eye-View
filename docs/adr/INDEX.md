...
| [0032](./0032-mcp-sdk-transport-protocol-session-design.md) | Incremental official MCP SDK adoption with preserved stdio compatibility | Accepted; OQ-1 and Tadpole client-evidence gate satisfied; Task 6.2 authorized | 2026-09-08 |
