...
| [0032](./0032-mcp-sdk-transport-protocol-session-design.md) | Incremental official MCP SDK adoption with preserved stdio compatibility | Accepted; OQ-1 policy resolved, HTTP implementation blocked on Tadpole client-fix evidence | 2026-09-08 |
